...
export default function Hero() {
  return (
    <div className="animate-fade-in">
      ...
      <p
        className={cn(
          "max-w-[400px] text-muted-foreground text-xs mb-10",
          jetbrains.className
        )}
      >
        Currently working with{" "}
        <span className="font-mono text-foreground/90 underline-offset-2 font-semibold">
          Go
        </span>{" "}
        for backend microservices, DevOps with{" "}
